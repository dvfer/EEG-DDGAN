...
Optional residual PostNet-style smoothing on `TTSGenerator`'s output, to suppress patch-boundary seam artifacts (excess high-frequency content) in synthetic EEG, trained end-to-end with no separate coupling to another network.
